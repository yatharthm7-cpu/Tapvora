  ...
  return <>
    ...
    <div className="business-manage-grid">
      <form action={updateBusinessAction}><input type="hidden" name="id" value={business.id} /><section className="form-card"><h2>Business details</h2><p>Changing the name or review link also updates every assigned card.</p><div className="form-grid">
        ...
        <div className="field field-full"><label htmlFor="address">Business address</label><textarea className="textarea" id="address" name="address" rows={2} maxLength={500} autoComplete="street-address" defaultValue={business.address || ""} placeholder="Shop number, street, area, city, state and PIN code" /></div>
